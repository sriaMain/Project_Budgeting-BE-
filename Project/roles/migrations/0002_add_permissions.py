...
def seed(apps, schema_editor):
    ...
    c_users = PermissionCategory.objects.create(permission_category_name="User Management")
    c_roles = PermissionCategory.objects.create(permission_category_name="Role Management")
    c_rbac  = PermissionCategory.objects.create(permission_category_name="RBAC Core")
